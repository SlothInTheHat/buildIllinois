...
CheetCode - An interactive coding interview platform where an AI interviewer watches you code, provides hints, and gives comprehensive feedback. Built with React + TypeScript + Vite, deployed on Vercel with serverless functions.
